...
public class ParallaxConstraintLayout extends ConstraintLayout implements Parallaxable {
    ...
    public ParallaxConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOffset(@FloatRange(from = -1.0, to = 1.0) float offset) {
        for (int i = getChildCount() - 1; i >= 0; i--) {
            ...
            ParallaxConstraintLayout.LayoutParams p = (LayoutParams) child.getLayoutParams();
